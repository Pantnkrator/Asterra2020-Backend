...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-PJ8M5SK";Vc.Cb="3i0";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var ad=Zc,bd=null,cd=null,dd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=33",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
(t?r:th(r)))}var d=a.Jc,e=a.protocol;e+=a.cc?"//"+d+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";e+=";src="+th(d)+(";type="+th(a.Mc))+(";cat="+th(a.hb));var f=a.Yf||{};C(f,function(n,r){e+=";"+th(n)+"="+th(r+"")});if(sh(c,a)){rh(a.mc)&&c("u",a.mc);rh(a.kc)&&c("tran",a.kc);c("gtm",Rg());!1===a.Cf&&c("npa","1");if(a.Ic){var h=oh("dc",a.Ha);h&&h.length&&c("gcldc",h.join("."));var k=oh("aw",a.Ha);k&&k.length&&c("gclaw",k.join("."));var l=ph();l&&c("gac",l);kh(a.Ha,void 0,a.Uf,a.Vf);
var m=gh[hh(a.Ha)];m&&c("auiddc",m)}rh(a.$c)&&c("prd",a.$c,!0);C(a.ld,function(n,r){c(n,r)});e+=b||"";rh(a.Xb)&&c("~oref",a.Xb);a.cc?kc(e+"?",a.B):lc(e+"?",a.B,a.w)}else I(a.w)};var ii={},ji=["G","GP"];ii.Ke="";var ki=ii.Ke.split(",");function li(){var a=Wc;return a.gcq=a.gcq||new mi}
...
b);return F[a]},hk=function(a,b,c){return Gf(a,b,void 0===c?!0:!!c)},ik=function(a,b){if(Wd()){b&&I(b)}else kc(a,b)},jk=function(a){return!!xj(a,"init",!1)},kk=function(a){vj(a,"init",!0)},lk=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/js":ad;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";S(Q("https://","http://",c))},mk=function(a,b){var c=a[b];return c};var nk=qj.Eg;var Kk=new xa;function Lk(a,b){function c(h){var k=af(h),l=$e(k,"protocol"),m=$e(k,"host",!0),n=$e(k,"port"),r=$e(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==n||"https"==l&&"443"==n)l="web",n="default";return[l,m,n,r]}for(var d=c(String(a)),e=c(String(b)),f=0;f<d.length;f++)if(d[f]!==e[f])return!1;return!0}
